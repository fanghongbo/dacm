...
[![Build Status](https://travis-ci.org/nacos-group/nacos-sdk-go.svg?branch=master)](https://travis-ci.org/nacos-group/nacos-sdk-go) [![Go Report Card](https://goreportcard.com/badge/github.com/fanghongbo/dacm/common/pkg/nacos-sdk-go)](https://goreportcard.com/report/github.com/fanghongbo/dacm/common/pkg/nacos-sdk-go) ![license](https://img.shields.io/badge/license-Apache--2.0-green.svg)
...
使用`go get`安装SDK：
```sh
$ go get -u github.com/fanghongbo/dacm/common/pkg/nacos-sdk-go
```
## 快速使用
* ClientConfig
